-- All Media — Reparatur: fehlende Schema-Teile 3 bis 6 in einem Rutsch.
-- Erzeugt am 31.08.2026. Idempotent: mehrfaches Ausfuehren schadet nicht.
-- Einspielen: Supabase-Dashboard -> SQL Editor -> New query -> alles einfuegen -> Run.
